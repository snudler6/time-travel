...
class TestPollPatcher(object):
    ...
    def test_one_fd(self):
        fd = mock.MagicMock()
        self.events_pool.add_future_event(2, fd, select.POLLIN)
    ...
    def test_timeout_before_event(self):
        fd = mock.MagicMock()
        self.events_pool.add_future_event(10, fd, select.POLLIN)
    ...
    def test_unregistered_events(self):
        ...
        self.events_pool.add_future_event(3, first_fd, select.POLLIN)
        self.events_pool.add_future_event(4, second_fd, select.POLLIN)
        self.events_pool.add_future_event(5, expected_fd, select.POLLIN)
    ...
    def test_multiple_fds_same_time(self):
        ...
        self.events_pool.add_future_event(3, fd1, select.POLLIN)
        self.events_pool.add_future_event(3, fd2, select.POLLIN)
        self.events_pool.add_future_event(3, fd3, select.POLLIN)
        self.events_pool.add_future_event(5, far_fd, select.POLLIN)
        self.events_pool.add_future_event(2, unwaited_fd, select.POLLIN)
    ...
    def test_same_fd_multiple_events(self):
        ...
        self.events_pool.add_future_event(3, fd, select.POLLIN)
        self.events_pool.add_future_event(3, fd, select.POLLOUT)
        self.events_pool.add_future_event(5, fd, select.POLLHUP)
    ...
    def test_same_event_multiple_timestamps(self):
        ...
        self.events_pool.add_future_event(1, fd, select.POLLIN)
        self.events_pool.add_future_event(2, fd, select.POLLIN)
        self.events_pool.add_future_event(2, fd, select.POLLOUT)
    ...
    def test_unregister(self):
        ...
        self.events_pool.add_future_event(1, fd, select.POLLIN)
        self.events_pool.add_future_event(5, fd, select.POLLIN)
    ...
    def test_modify(self):
        ...
        self.events_pool.add_future_event(1, fd, select.POLLIN)
        self.events_pool.add_future_event(5, fd, select.POLLIN)
        self.events_pool.add_future_event(10, fd, select.POLLOUT)
