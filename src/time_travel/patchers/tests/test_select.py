...
class TestSelectPatcher(object):
    ...
    def test_basic_usage(self):
        fd = mock.MagicMock()
        self.events_pool.add_future_event(100002,
                                          fd,
    ...
    def test_empty_lists(self):
        ...
        assert self.clock.time == 100017
    
    def test_future_event_after_timeout(self):
        fd = mock.MagicMock()
        self.events_pool.add_future_event(100027,
                                          fd,
                                          SelectPatcher.EventTypes.READ)
    ...
    def test_adding_unwaited_fds(self):
        ...
        self.events_pool.add_future_event(100003,
                                          first_fd,
                                          SelectPatcher.EventTypes.READ)
        self.events_pool.add_future_event(100004,
                                          second_fd,
                                          SelectPatcher.EventTypes.WRITE)
        self.events_pool.add_future_event(100005,
                                          waited_for_fd,
                                          SelectPatcher.EventTypes.READ)
    ...
    def test_fd_not_returned_twice(self):
        ...
        assert self.clock.time == 100003 + 6
          
    def test_same_fd_multiple_timestamps(self):
        fd = mock.MagicMock()
        
        self.events_pool.add_future_event(100001,
                                          fd,
                                          SelectPatcher.EventTypes.EXCEPTIONAL)
        self.events_pool.add_future_event(100002,
                                          fd,
